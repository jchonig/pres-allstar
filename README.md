...
9. G1LRO RNL-Z2 — g1lro.uk/?p=921 — £159 (radio-less, color screen, speaker/mic, UK-based)
10. Radio-less Nodes (no RF; speaker-mic or softphone; hubs, EmComm, monitoring)
11. Building a Hotspot (Pi Zero 2W, Pi 3B+, or Pi 4 + radio interface + ASL3)
11. Radio Interfaces (comparison table)
